...
import 'package:chat_app_tez_1/allModels/message_chat.dart';
...
import 'package:chat_app_tez_1/allScreens/full_photo_page.dart';
          ...
          child: Column(
            children: <Widget>[
              ...
              isLastMessageLeft(index)
                  ? Container(
                      child: Text(
                        DateFormat('dd MMM yyyy, hh:mm a','tr_TR').format(
